...
clear&&clear
echo -e "\033[1;31m———————————————————————————————————————————————————\033[1;37m"
echo -e "\033[1;32m              PAYLOAD + SSL |by: Luftssh "
echo -e "\033[1;31m———————————————————————————————————————————————————\033[1;37m"
echo -e "\033[1;36m              SCRIPT AUTOCONFIGURACION "
echo -e "\033[1;31m———————————————————————————————————————————————————\033[1;37m"
echo -e "\033[1;37mRequer ter as portas  ,80 e a livre 443"
echo
...
def main(host=LISTENING_ADDR, port=LISTENING_PORT):
    ...
    print "Se estava iniciado por favor feche o terminal\n"
...
echo
echo -e "Solucionador de erro da porta 443 com a SNI"
echo
echo -e "\e[0;31m                       by:Luftssh\e[0m"
